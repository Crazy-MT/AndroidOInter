 ...
 */
public class NoChangeFontTextView extends TextView implements LanguageChangableView {
    private int textId;//文字id
    private int hintId;//hint的id
    private int arrResId, arrResIndex;

    //  app:fontStyle="light" medium
    public NoChangeFontTextView(Context context) {
        super(context);
        init(context, null);
    }

    public NoChangeFontTextView(Context paramContext, AttributeSet paramAttributeSet) {
        super(paramContext, paramAttributeSet);
        init(paramContext, paramAttributeSet);
    }

    public NoChangeFontTextView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
